...
//   Future<ApiResponse> signUp(String name, String phone, String email,
//       String password, String gender, String dob, String city) async {
//     Response response = Response(requestOptions: RequestOptions(path: '22222'));
//     try {
//       response = await dioClient.post('${AppConstant.signup}', data: {
//         "name": name,
//         "email": email,
//         "password": password,
//         "phone": phone,
